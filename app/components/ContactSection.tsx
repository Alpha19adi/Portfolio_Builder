        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mt-12">
            ...
            {(personal.email || isEditMode) && (
              <CardWrapper href={personal.email ? `mailto:${personal.email}` : undefined}>
                <div className="group p-6 h-full bg-gray-900/50 border border-gray-800 rounded-2xl hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10 cursor-pointer">
                  ...
                  <div className="text-gray-500 text-sm mt-1 break-all">
                    {isEditMode ? (
                      <EditableText
                        ...
                        onSave={(v) => onUpdatePersonal("email", v)}
            ...
            {(personal.linkedIn || isEditMode) && (
              ...
              >
                <div className="group p-6 h-full bg-gray-900/50 border border-gray-800 rounded-2xl hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10 cursor-pointer">
                  ...
                  <div className="text-gray-500 text-sm mt-1 break-all">
                    {isEditMode ? (
                      <EditableText
                        ...
                        onSave={(v) => onUpdatePersonal("linkedIn", v)}
            ...
            {(personal.github || isEditMode) && (
              ...
              >
                <div className="group p-6 h-full bg-gray-900/50 border border-gray-800 rounded-2xl hover:border-pink-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/10 cursor-pointer">
                  ...
                  <div className="text-gray-500 text-sm mt-1 break-all">
                    {isEditMode ? (
                      <EditableText
                        ...
                        onSave={(v) => onUpdatePersonal("github", v)}
